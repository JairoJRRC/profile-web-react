!(function(e) {
  ...
  e(document).ready(function() {
    ...
    e(window).scroll(function() {
      e(this).scrollTop() > s.top - 20 && a.hasClass("default")
        ...
        : e(this).scrollTop() <= s.top - 20 &&
          a.hasClass("switched-header") &&
      ...
      e("a.scroll").smoothScroll({ speed: 800, offset: -64 }),
    ...
    for (var t = e(".block-background-image"), o = 0; o < t.length; o++)
      t.eq(o).attr("data-background") &&
        t
          .eq(o)
          .css("background-image", "url(" + t.eq(o).data("background") + ")");
    ...
    e(".submit").on("click", function() {
      r.removeClass("errorForm"),
        l.removeClass("errorForm"),
        n.removeClass("errorForm");
      var a = !1,
        s = r.val();
      ...
      if (
        ("" == i || " " == i
          ? (n.addClass("errorForm"), (a = !0))
          : o.test(i) || (n.addClass("errorForm"), (a = !0)),
        1 == a)
      )
        return !1;
      var d = c.serialize();
    ...
    for (var o = 0; o < d.length; o++)
      u.on("click", function() {
        ...
        u.on("mouseenter", function() {
          u.hasClass("t-active") &&
            (m.stop().animate({ opacity: 0 }, "slow"),
            u.removeClass("t-active")),
            e(this).addClass("t-active"),
            e(".testi-details .td").hide(),
    ...
    e(".fact-list").appear(function() {
      for (var e = 0; e < f.length; e++) {
        var a = f.eq(e).html();
        f.eq(e).countTo({ from: 0, to: a, speed: 2e3, refreshInterval: 10 });
      }
    }),
    ...
    e(p).on("click", function() {
      ...
      e(window).resize(function() {
        ...
        a > 320 &&
          h.is(":hidden") &&
          (h.removeAttr("style"), v.removeClass("mobile"));
      }),
      h.on("click", function(a) {
        e(a.target).is("a") &&
          e(a.target).hasClass("mobile") &&
          (h.slideToggle(), v.removeClass("mobile"));
      }),
